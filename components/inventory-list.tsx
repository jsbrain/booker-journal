...
export function InventoryList() {
  ...
  const loadInventoryData = async () => {
    ...
    try {
      ...
      devLogError('Failed to load inventory:', error)
      setErrorMessage(getPublicErrorMessage(error, 'Failed to load inventory'))
    } finally {
      setLoading(false)
    }
  }
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      devLogError('Failed to delete purchase:', error)
      setErrorMessage(getPublicErrorMessage(error, 'Failed to delete purchase'))
    }
                      ...
                      <div className="text-right shrink-0">
                        ...
                        <div className="flex items-center text-sm text-muted-foreground">
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Calculated as current stock × average buying price
                              (average cost method)
                            </TooltipContent>
                          </Tooltip>
