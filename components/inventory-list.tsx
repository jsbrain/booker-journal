          ...
          {inventorySummary.length === 0 ? (
            ...
            <div className="space-y-4">
              {inventorySummary.map((item) => {
                ...
                return (
                  <div key={item.productId} className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b pb-3 last:border-0 last:pb-0 gap-2">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-sm text-muted-foreground">
                        Avg. selling price: {formatCurrency(item.averageSellingPrice)}
                      </div>
                      ...
                      <CardContent className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            <span className="font-medium truncate">{purchase.product.name}</span>
                          ...
                          {purchase.note && (
                            <p className="text-sm text-muted-foreground mt-1 line-clamp-2">{purchase.note}</p>
                          )}
